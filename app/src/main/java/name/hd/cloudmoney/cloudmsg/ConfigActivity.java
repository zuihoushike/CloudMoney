...
public class ConfigActivity extends Activity implements View.OnClickListener{
    ...
    private ImageView imageScan = null,back=null;
    ...
    private void switchTo(TextView view, boolean on){
        ...
        if(on){
            view.setCompoundDrawablesWithIntrinsicBounds(0,0, R.mipmap.switch_on, 0);
        }
        else{
            view.setCompoundDrawablesWithIntrinsicBounds(0,0, R.mipmap.switch_off, 0);
        }
    }
    ...
    private void initButtons() {
        ...
        (back=findViewById(R.id.config_back)).setOnClickListener(this);
