...
public class DoubleDatePickerDialog extends AlertDialog implements OnClickListener, OnDateChangedListener {
	...
	public interface OnDateSetListener {
		...
		void onDateSet(DatePicker startDatePicker, int startYear, int startMonthOfYear, int
                startDayOfMonth,
	...
	public DoubleDatePickerDialog(Context context, int theme, OnDateSetListener callBack) {
	 ...
	 * @param mDatePicker
	 */
	public void hidDay(DatePicker mDatePicker) {
